...
import (
	...
	"fmt"
	"io"
	integrations "sonnda-api/internal/app/interfaces/external"
	"time"
...
var _ integrations.StorageService = (*StorageAdapter)(nil)

func NewStorageAdapter(
	ctx context.Context,
	bucketName,
	projectID string,
	opts ...option.ClientOption) (*StorageAdapter, error) {
	var (
		client *storage.Client
		err    error
	)
...
func (a *StorageAdapter) GetSignedURL(
	ctx context.Context,
	uri string,
