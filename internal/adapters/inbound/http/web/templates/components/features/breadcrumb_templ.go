...
// TODO: definir o lugar ideal para esse arquivo
func Breadcrumb(breadcrumb string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if breadcrumb != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/inbound/http/web/templates/components/features/breadcrumb.templ`, Line: 7, Col: 75}
			}
