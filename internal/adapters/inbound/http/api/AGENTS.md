<!-- internal/adapters/inbound/http/api/AGENTS.md -->
# AGENTS.md

Simple instructions for coding in api package

## Error handling (MANDATORY)
- HTTP error presentation is centralized in `internal/adapters/inbound/http/shared/httperr` (shared by API and WEB).
- Handlers and middlewares must call `httperr.WriteError(c, err)`; do not manually build error JSON.
