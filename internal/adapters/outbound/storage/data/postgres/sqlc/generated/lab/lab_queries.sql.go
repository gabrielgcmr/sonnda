...
// Creators
// ============================================================
func (q *Queries) CreateLabReport(ctx context.Context, arg CreateLabReportParams) (CreateLabReportRow, error) {
...
// Getters
// ============================================================
func (q *Queries) GetLabReportByID(ctx context.Context, id uuid.UUID) (GetLabReportByIDRow, error) {
	row := q.db.QueryRow(ctx, getLabReportByID, id)
	var i GetLabReportByIDRow
	err := row.Scan(
		&i.ID,
		&i.PatientID,
		&i.PatientName,
