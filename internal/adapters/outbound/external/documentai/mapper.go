...
func mapDocumentToExtractedLabs(doc *documentaipb.Document) *services.ExtractedLabReport {
	out := &services.ExtractedLabReport{}
...
func mapTestResult(doc *documentaipb.Document, ent *documentaipb.Document_Entity) services.ExtractedTestResult {
	var tr services.ExtractedTestResult
...
func mapTestItem(doc *documentaipb.Document, ent *documentaipb.Document_Entity) services.ExtractedTestItem {
	var item services.ExtractedTestItem
