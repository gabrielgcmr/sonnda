// internal/features/documentprocessing/processing/create_lab_report_from_document_test.go
package processing
...
func (r *labRepoStub) FindByFingerprint(context.Context, uuid.UUID, string) (*labs.LabReport, error) {
	r.signatureCalls++
...
func (r *labRepoStub) CreateFromDocument(_ context.Context, report *labs.LabReport, metadata processingdomain.LaboratoryReportMetadata) error {
	if r.createErr != nil {
		return r.createErr
	}
	r.saved = report
